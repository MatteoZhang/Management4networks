...
def arrival(environment, nation, arrival_rate):
    ...
    while True:
        ...
        if nation == "china":
            stats_one_nation.append(arrival_rate2)
...
class Client(object):
    ...
    def run(self):
        ...
        for j in range(1, self.k + 1):
            pack_dim = random.randint(8000, 16000)  # bit
...
class Servers(object):
    ...
    def serve(self, name_client, req, client, pack_dim):
        ...
        with self.servers.request() as request:  # create obj then destroy
            ...
            print("service time for", name_request, " : ", service_time, "Request arrived at the server at: ",
